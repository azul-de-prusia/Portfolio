    ...
    render(){
        return(
            <div className="contact">
                ...
                <ul>
                    <li className="tex">
                    <h3><img src="https://i.ibb.co/DkyDQcw/portfolio.png" className="icon"/>  Curriculum Vitae</h3><a href="https://i.ibb.co/ZWvjTBX/cv.jpg" target="_blank" className="href">Curriculum Vitae viewer</a>
